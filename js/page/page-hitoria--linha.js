...
const avancaAvanca = document.querySelector('.avanca-avanca');
const voltaVolta = document.querySelector('.volta-volta');
const gapAnos = 72;
...
voltaVolta.addEventListener('click', e => {
    [...ano].forEach(a => {
        if (a.className === 'ano ativo') {
            ativo = [...ano].indexOf(a) - 1;
        }
...
avancaAvanca.addEventListener('click', e => {
    [...ano].forEach(a => {
        if (a.className === 'ano ativo') {
            ativo = [...ano].indexOf(a) + 1;
        }
